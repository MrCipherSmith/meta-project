...
| R2-2 | registered-extension provenance | SC_R18_REGISTERED_EXTENSION_PROVENANCE, EXTENSION_ESCALATION (H-02) | ⬜ | — | — | требует R2-1 |
| R2-3 | bound-parallel-wave над extensions | SC_R08_BOUND_PARALLEL_WAVE | ⬜ | — | — | требует R2-1 |
| R2-4 | Interactive CLI / TUI adapter | SC_R13_TUI_DEFERRED | ✅ | `feature/keryx-release2-tui` (PR #25) | 2026-07-13 | flow 022; provider/model selection как в opencode, без хардкод-дефолта; `deps {}`. Детали — в ветке R2-4 (при мёрже сверить строку). |
